                ...
                : (this.state.counter === 1) ?
                    <div id="zameeel">
                        ...
                        <form>
                            ...
                            <input type="password" id="3" value={this.state.passowrd} placeholder="passowrd" name="Password" onChange={this.tochange.bind(this)} /> <br />
                        </form>
